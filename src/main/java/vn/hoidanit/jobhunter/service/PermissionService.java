...
public class PermissionService {
    ...
    public Permission CreateAPremissionService(Permission p) {
        return this.permissionRepository.save(p);
    }

    public Permission UpdateAPremissionService(Permission p) {
        Permission permissionDB = this.GetPermissionByIdService(p.getId());
    ...
    public void DeleteAPremissionService(long id) {
    ...
    public ResultPaginationDTO GetAllPermissionsService(Pageable pageable) {
